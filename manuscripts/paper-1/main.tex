...
\begin{document}
    ...
    %%Based on this analysis, we established unambiguous and well-defined definitions for quality attributes of the digital twin. These definitions were subsequently utilized in our manual reviews.
